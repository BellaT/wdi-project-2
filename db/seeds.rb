...
u1.profile_image = File.open(Rails.root + "app/assets/images/Bill-Murray-3.jpg")
u1.save!

u2 = User.create!(username: "alexchin", first_name: "Alex", last_name: "Chin", email: "alex@alex.com", password: "password", admin: true)
u2.profile_image = File.open(Rails.root +"app/assets/images/bill-murray2.jpg")
u2.save!
...
f1.main_image = File.open(Rails.root +"app/assets/images/sonar-head.jpg")
f1.second_image = File.open(Rails.root +"app/assets/images/sonar-festival-1.jpg")
f1.third_image = File.open(Rails.root +"app/assets/images/sonar3.jpg")
f1.save!
...
f2.main_image = File.open(Rails.root +"app/assets/images/glastonbury-main.jpg")
f2.second_image = File.open(Rails.root +"app/assets/images/glastonbury-second.jpg")
f2.third_image = File.open(Rails.root +"app/assets/images/glastonbury-third.jpg")
f2.save!
...
f3.main_image = File.open(Rails.root +"app/assets/images/dekmantel-main.jpg")
f3.second_image = File.open(Rails.root +"app/assets/images/dekmantel-second.jpg")
f3.third_image = File.open(Rails.root +"app/assets/images/dekmantel3.jpg")
f3.save!
...
f4.main_image = File.open(Rails.root +"app/assets/images/dimensions4.jpg")
f4.second_image = File.open(Rails.root +"app/assets/images/dimensions2.jpg")
f4.third_image = File.open(Rails.root +"app/assets/images/boat-dimensions.jpg")
f4.save!
...
f5.main_image = File.open(Rails.root +"app/assets/images/roskilde1.jpg")
f5.second_image = File.open(Rails.root +"app/assets/images/roskilde2.jpg")
f5.third_image = File.open(Rails.root +"app/assets/images/roskilde3.jpg")
f5.save!
...
f6 = Festival.create!(title: "CMA Music Festival",
                      ...
                      website: "http://www.dimensionsfestival.com/")
f6.main_image = File.open(Rails.root +"app/assets/images/cma1.jpg")
f6.second_image = File.open(Rails.root +"app/assets/images/cma2.jpg")
f6.third_image = File.open(Rails.root +"app/assets/images/cma3.jpg")
f6.save!
...
f7.main_image = File.open(Rails.root +"app/assets/images/great-escape1.jpg")
f7.second_image = File.open(Rails.root +"app/assets/images/great-escape2.jpeg")
f7.third_image = File.open(Rails.root +"app/assets/images/brighton3.jpg")
f7.save!
...
f8.main_image = File.open(Rails.root +"app/assets/images/brooklyn1.jpg")
f8.second_image = File.open(Rails.root +"app/assets/images/brooklyn3.jpg")
f8.third_image = File.open(Rails.root +"app/assets/images/brooklyn2.jpg")
f8.save!
...
f9.main_image = File.open(Rails.root +"app/assets/images/nice-jazz1.jpg")
f9.second_image = File.open(Rails.root +"app/assets/images/nice-jazz3.jpg")
f9.third_image = File.open(Rails.root +"app/assets/images/nice-jazz2.jpg")
f9.save!
...
f10.main_image = File.open(Rails.root +"app/assets/images/bpm4.jpg")
f10.second_image = File.open(Rails.root +"app/assets/images/bpm2.jpg")
f10.third_image = File.open(Rails.root +"app/assets/images/bpm3.jpg")
f10.save!
...
f11.main_image = File.open(Rails.root +"app/assets/images/SXSW1.jpg")
f11.second_image = File.open(Rails.root +"app/assets/images/SXSW2.jpg")
f11.third_image = File.open(Rails.root +"app/assets/images/SXSW3.jpg")
f11.save!
